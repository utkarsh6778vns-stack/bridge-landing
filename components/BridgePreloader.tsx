...
export default function BridgePreloader({ onComplete }: BridgePreloaderProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0B1221]">
            <div className="relative flex items-center">
                {/* Container for the logo graphic - perfectly symmetric centered at 120 */}
                <div className="relative flex items-center justify-center">
                    ...
                    >
                        ...
                        {/* Circle around Heart (Center 120, Radius 30) */}
                        <motion.circle
                            cx="120"
                            cy="60"
                            r="30"
                        ...
                        {/* Heart Icon (Centered in the circle at 120, 60) */}
                        <motion.path
                            // Scaled and centered heart path (shifted to 120)
                ...
                >
                    <h1 className="text-7xl font-extrabold text-[#3B82F6] tracking-tighter">Bridge</h1>
                </motion.div>
            </div>
        </div>
    );
